...
class HealthStat extends React.Component {
    ...
    render() {
      ...
      return (
        <div className="App container" style={{color:'white',backgroundColor:"black"}}>
          <div className="row">
            <div className="col-xs-12">
                <br/>
              <h1 style={{color:'orange'}}>BMI Calculator</h1>
              <br/>
            ...
            <div className="col-sm-6">
              <form>
                <div className="form-group">
                  ...
                  <div className="row">
                    <div className="col-xs-12">
                      <input className="form-control" placeholder="weight in pounds" id="bmiWeight" type="number" min="1" max="1000" value={ this.state.weight } onChange={ this.handleWeightChange } />
