...
/* ********************************************************************************* */
 ...
 /* ********************************************************************************* */
   return (
       <div className="col-sm-6 offset-sm-3" style={{color:'orange',backgroundColor:"black"}}>
         <br/>
         <br/>
     <h1 style={{color:'orange',textAlign:'center'}}>Membership Form</h1>
        <br/>
         <br/>
        <div className="mb-3">
            <label>Gender </label>
        ...
        <div className="mb-3">
            <button onClick={membershipform} className="btn btn-success">Submit</button>
        </div>
       </div>
   )
}
